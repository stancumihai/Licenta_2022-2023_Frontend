...
import { COLOR2, COLOR2_D_20, COLOR2_D_40, FONT_FAMILY, LOGIN_INPUTS_COLOR } from '../../Library/constants';
...
export const successfullyRegisteredClassName: string = mergeStyles({
    position: 'relative',
    top: '2vh',
    left: '4vw',
    fontFamily: FONT_FAMILY,
